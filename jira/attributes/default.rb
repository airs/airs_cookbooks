...
default[:jira][:entityengine_xml] = "#{default[:jira][:install]}/atlassian-jira/WEB-INF/classes/entityengine.xml"
default[:jira][:setenv_sh] = "#{default.jira.install}/bin/setenv.sh"
